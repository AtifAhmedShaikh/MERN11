  ...
  return (
    <div className="flex justify-center gap-11">
      ...
      <div className="w-[45rem] flex flex-col">
        <h2 className="text-xl font-bold">Total Price : 87 </h2>
      ...
      <form className="w-[45%] flex flex-col gap-5 rounded-md bg-gray-100 p-5">
        <h4>Pay with cart </h4>
        ...
        <button className="bg-blue-500 rounded-md text-gray-100 w-fit px-5 py-3">
          payment{" "}
        </button>
      </form>
    </div>
